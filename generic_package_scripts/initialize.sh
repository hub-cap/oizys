...
python-all python-sphinx python-distutils-extra python-gflags python-mox python-carrot python-boto \
python-amqplib python-sqlalchemy-ext python-sqlalchemy python-eventlet python-routes python-webob python-swift \
